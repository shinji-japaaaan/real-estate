...
## 2026-06-15 13:14（週次ペルソナUXレビュー自動チェック）
...
### 先週のコミット（上位10件）
- report: 2026-06-14 日次実装レポートを生成
- report: 2026-06-13 日次実装レポートを生成
- report: 2026-06-12 日次実装レポートを生成
- report: 2026-06-11 日次実装レポートを生成
- Merge branch 'main' of https://github.com/terra-realty-jp/real-estate
- fix: IndexNowキーをローテーション — 旧キーの検証失敗キャッシュを回避
- report: 2026-06-10 日次実装レポートを生成
- fix: IndexNow 403（キー検証キャッシュ）を警告扱いに — 週次再送信で自己回復するため
- feat: 月次相場レポート自動生成 — 人手ゼロでGoogleに毎月ページを積み上げる集客フライホイール
- Merge branch 'main' of https://github.com/terra-realty-jp/real-estate
...
## 2026-06-22 13:11（週次ペルソナUXレビュー自動チェック）
...
### 先週のコミット（上位10件）
- report: 2026-06-21 日次実装レポートを生成
- report: 2026-06-20 日次実装レポートを生成
- report: 2026-06-19 日次実装レポートを生成
- report: 2026-06-18 日次実装レポートを生成
- report: 2026-06-17 日次実装レポートを生成
- report: 2026-06-16 日次実装レポートを生成
- report: 2026-06-16 日次実装レポートを生成
- review: Weekly persona UX review checklist added (2026-06-15)
...
## 2026-06-29 12:52（週次ペルソナUXレビュー自動チェック）
...
### 先週のコミット（上位10件）
- report: 2026-06-28 日次実装レポートを生成
- report: 2026-06-27 日次実装レポートを生成
- report: 2026-06-26 日次実装レポートを生成
- report: 2026-06-25 日次実装レポートを生成
- report: 2026-06-24 日次実装レポートを生成
- report: 2026-06-23 日次実装レポートを生成
- report: 2026-06-23 日次実装レポートを生成
- review: Weekly persona UX review checklist added (2026-06-22)
...
## 2026-07-06 12:28（週次ペルソナUXレビュー自動チェック）
...
### 先週のコミット（上位10件）
- report: 2026-07-05 日次実装レポートを生成
- report: 2026-07-04 日次実装レポートを生成
- report: 2026-07-03 日次実装レポートを生成
- report: 2026-07-02 日次実装レポートを生成
- data: 金利データを月次更新（2026-07-02）
- report: 2026-07-01 日次実装レポートを生成
- data: エリア単価データを月次更新（2026-07-01）
- report: 2026-06-30 日次実装レポートを生成
- report: 2026-06-29 日次実装レポートを生成
- review: Weekly persona UX review checklist added (2026-06-29)
...
## 2026-07-13 11:43（週次ペルソナUXレビュー自動チェック）
...
### 先週のコミット（上位10件）
- report: 2026-07-12 日次実装レポートを生成
- report: 2026-07-11 日次実装レポートを生成
- report: 2026-07-10 日次実装レポートを生成
- report: 2026-07-08 日次実装レポートを生成
- report: 2026-07-07 日次実装レポートを生成
- report: 2026-07-06 日次実装レポートを生成
- review: Weekly persona UX review checklist added (2026-07-06)
...
## 2026-07-20 11:52（週次ペルソナUXレビュー自動チェック）
...
### 先週のコミット（上位10件）
- report: 2026-07-19 日次実装レポートを生成
- report: 2026-07-18 日次実装レポートを生成
- report: 2026-07-17 日次実装レポートを生成
- report: 2026-07-16 日次実装レポートを生成
- report: 2026-07-15 日次実装レポートを生成
- report: 2026-07-14 日次実装レポートを生成
- report: 2026-07-13 日次実装レポートを生成
...
## 2026-07-27 11:51（週次ペルソナUXレビュー自動チェック）
...
### 先週のコミット（上位10件）
- report: 2026-07-26 日次実装レポートを生成
- report: 2026-07-25 日次実装レポートを生成
- report: 2026-07-24 日次実装レポートを生成
- report: 2026-07-23 日次実装レポートを生成
- report: 2026-07-22 日次実装レポートを生成
- report: 2026-07-21 日次実装レポートを生成
- report: 2026-07-20 日次実装レポートを生成
- review: Weekly persona UX review checklist added (2026-07-20)
...
## 2026-08-03 11:43（週次ペルソナUXレビュー自動チェック）
...
### 先週のコミット（上位10件）
- report: 2026-08-02 日次実装レポートを生成
- data: 金利データを月次更新（2026-08-02）
- report: 2026-08-01 日次実装レポートを生成
- data: エリア単価データを月次更新（2026-08-01）
- report: 2026-07-31 日次実装レポートを生成
- report: 2026-07-30 日次実装レポートを生成
- report: 2026-07-29 日次実装レポートを生成
- report: 2026-07-28 日次実装レポートを生成
- report: 2026-07-27 日次実装レポートを生成
- review: Weekly persona UX review checklist added (2026-07-27)
...
## 2026-08-10 10:43（週次ペルソナUXレビュー自動チェック）
...
### 先週のコミット（上位10件）
- report: 2026-08-09 日次実装レポートを生成
- report: 2026-08-08 日次実装レポートを生成
- report: 2026-08-07 日次実装レポートを生成
- report: 2026-08-06 日次実装レポートを生成
- report: 2026-08-05 日次実装レポートを生成
- report: 2026-08-04 日次実装レポートを生成
- report: 2026-08-03 日次実装レポートを生成
- review: Weekly persona UX review checklist added (2026-08-03)
...
## 2026-08-17 10:11（週次ペルソナUXレビュー自動チェック）
...
### 先週のコミット（上位10件）
- report: 2026-08-16 日次実装レポートを生成
- report: 2026-08-15 日次実装レポートを生成
- report: 2026-08-14 日次実装レポートを生成
- report: 2026-08-13 日次実装レポートを生成
- report: 2026-08-12 日次実装レポートを生成
- report: 2026-08-11 日次実装レポートを生成
- report: 2026-08-10 日次実装レポートを生成
- review: Weekly persona UX review checklist added (2026-08-10)
...
## 2026-08-24 10:13（週次ペルソナUXレビュー自動チェック）
...
### 先週のコミット（上位10件）
- report: 2026-08-23 日次実装レポートを生成
- report: 2026-08-22 日次実装レポートを生成
- report: 2026-08-21 日次実装レポートを生成
- report: 2026-08-20 日次実装レポートを生成
- report: 2026-08-19 日次実装レポートを生成
- report: 2026-08-18 日次実装レポートを生成
- report: 2026-08-17 日次実装レポートを生成
...
## 2026-08-31 12:53（週次ペルソナUXレビュー自動チェック）
...
### 先週のコミット（上位10件）
- report: 2026-08-30 日次実装レポートを生成
- report: 2026-08-29 日次実装レポートを生成
- report: 2026-08-29 日次実装レポートを生成
- report: 2026-08-28 日次実装レポートを生成
- report: 2026-08-26 日次実装レポートを生成
- report: 2026-08-25 日次実装レポートを生成
- report: 2026-08-24 日次実装レポートを生成
